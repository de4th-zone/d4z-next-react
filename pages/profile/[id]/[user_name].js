...
import { singleUserThunk } from '../../../redux/thunks/userThunk';
import { fetchCategoryThunk } from '../../../redux/thunks/categoryThunk';

const Profile = ({ login, singleUser, singleUserThunk }) => {
	const router = useRouter();
	const { id, user_name } = router.query;
	useEffect(() => {
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-sm-9">
						<Tab.Container id="profile-tabs" defaultActiveKey="activity">
...
Profile.getInitialProps = async (ctx) => {
	...
	//await ctx.store.dispatch(singleUserThunk(ctx.query.id, ctx.query.user_name));
};
...
export default Authentication(connect(mapStateToProps, mapDispatchToProps)(Profile));
